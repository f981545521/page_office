...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function addSeals() {
				...
				//第一次自刷新
				document.getElementById("iframe1").src = "AddSeal.jsp?id=" + str[count];
	...
	<body>
		<%
			String url = request.getSession().getServletContext().getRealPath("InsertSeal/Word/BatchAddSeal/doc/" + "/");
		%>	
