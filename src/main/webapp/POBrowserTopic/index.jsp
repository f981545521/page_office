        ...
        <div class="demo mc">
         ...
         <div style="margin : 10px" align="center">
           <table   style="border-collapse:separate; border-spacing:20px; ">
             <tr>
              <td>1.POBrowser方式最简单的打开编辑保存文档：<a href="javascript:POBrowser.openWindowModeless('Word1.jsp' , 'width=1200px;height=800px;');">Word1.jsp</a>
              </td>
              </tr>
             <tr>
			 <td>2.向POBrowser打开的页面传递参数1：<a href="javascript:POBrowser.openWindowModeless('Word2.jsp?id=1' , 'width=1200px;height=800px;');">Word2.jsp</a></td>
			 </tr>
             <tr>
			 <td>3.向POBrowser打开的页面传递参数2：<a href="javascript:POBrowser.openWindowModeless('Word3.jsp' , 'width=1200px;height=800px;');" onclick="getText()">Word3.jsp</a></td>
			 <tr>
			 <td>请输入值：
