        ...
        <div class="zz-talbeBox mc" >
            ...
            <table class="zz-talbe">
                ...
                <tbody>
					...
					<%
					if (key != null && key.trim().length() > 0) {  %>
                      <a style="color:#00217d;" href="javascript:POBrowser.openWindowModeless('Edit.jsp?id=<%=id %>' ,'width=1200px;height=800px;','<%=URLDecoder.decode(key, "UTF-8") %>');">编辑</a>
                    ...
                    <%
                     if (key == null || key=="") { %>
                      <a style="color:#00217d;" href="javascript:POBrowser.openWindowModeless('Edit.jsp?id=<%=id %>' ,'width=1200px;height=800px;');">编辑</a>
